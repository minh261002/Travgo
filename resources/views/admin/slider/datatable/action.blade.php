<a href="{{ route('admin.slider.item.index', $id) }}" class="btn btn-sm btn-info">
    <i class="ti ti-photo fs-1"></i>
</a>

<a href="{{ route('admin.slider.edit', $id) }}" class="btn btn-sm btn-primary">
            ...
            <div class="modal-footer">
                <div class="w-100">
                    <div class="row">
                        ...
                        <div class="col">
                            <a href="{{ route('admin.slider.delete', $id) }}" class="btn btn-danger w-100 btn-delete"
